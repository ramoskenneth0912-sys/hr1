<?php
/**
 * MY LEARNING — Employee Portal ESS module.
 * Session-scoped, employee-only. The page shell is rendered by PHP; the
 * learning module itself is a React widget mounted below.
 */
...
if (!$employeeId) {
    ...
    echo '<div class="page-header fade-in-up"><div><h1 class="page-title">My Learning</h1></div></div>';
