<?php
/**
 * MY TRAININGS — Employee Portal ESS module.
 * Session-scoped, employee-only. The page shell is rendered by PHP; the
 * trainings module itself is a React widget mounted below.
 */
...
if (!$employeeId) {
    ...
    echo '<div class="page-header fade-in-up"><div><h1 class="page-title">My Trainings</h1></div></div>';
...
<div
    data-react-widget="my-trainings"
