<?php
/**
 * MY COMPETENCIES — Employee Portal ESS module.
 * Session-scoped, employee-only. The page shell is rendered by PHP; the
 * competencies module itself is a React widget mounted below.
 */
...
if (!$employeeId) {
    ...
    echo '<div class="page-header fade-in-up"><div><h1 class="page-title">My Competencies</h1></div></div>';
    echo '<div class="alert alert-warning">No employee profile linked to your account. Please contact HR.</div>';
    require_once __DIR__ . '/../../includes/footer.php';
    exit;
}

$pageTitle = 'My Competencies';
$currentModule = 'my-competencies';
...
?>
<div
    data-react-widget="my-competencies"
