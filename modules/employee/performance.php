<?php
/**
 * MY PERFORMANCE — Employee Portal ESS module.
 * Session-scoped, employee-only. The page shell is rendered by PHP; the
 * performance module itself is a React widget mounted below.
 */
...
if (!$employeeId) {
    ...
    echo '<div class="page-header fade-in-up"><div><h1 class="page-title">My Performance</h1></div></div>';
...
?>
<div
    data-react-widget="my-performance"
